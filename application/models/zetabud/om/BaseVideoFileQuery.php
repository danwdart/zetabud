 ...
 *
 * @method     VideoFileQuery leftJoinUser($relationAlias = null) Adds a LEFT JOIN clause to the query using the User relation
 * @method     VideoFileQuery rightJoinUser($relationAlias = null) Adds a RIGHT JOIN clause to the query using the User relation
 * @method     VideoFileQuery innerJoinUser($relationAlias = null) Adds a INNER JOIN clause to the query using the User relation
 *
...
abstract class BaseVideoFileQuery extends ModelCriteria
{
	...
	{
		return $this
			->addUsingAlias(VideoFilePeer::USER_ID, $user->getId(), $comparison);
	}
