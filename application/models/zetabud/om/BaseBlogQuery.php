 ...
 *
 * @method     BlogQuery leftJoinUser($relationAlias = null) Adds a LEFT JOIN clause to the query using the User relation
 * @method     BlogQuery rightJoinUser($relationAlias = null) Adds a RIGHT JOIN clause to the query using the User relation
 * @method     BlogQuery innerJoinUser($relationAlias = null) Adds a INNER JOIN clause to the query using the User relation
 *
...
abstract class BaseBlogQuery extends ModelCriteria
{
	...
	{
		return $this
			->addUsingAlias(BlogPeer::USER_ID, $user->getId(), $comparison);
	}
