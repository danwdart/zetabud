...
/**
 * Base static class for performing query and update operations on the 'video_file' table.
 *
 * 
 *
...
abstract class BaseVideoFilePeer {
	...
	const CLASS_DEFAULT = 'zetabud.VideoFile';
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(VideoFilePeer::USER_ID);
			$criteria->addSelectColumn(VideoFilePeer::ARTIST);
			$criteria->addSelectColumn(VideoFilePeer::ALBUM);
			$criteria->addSelectColumn(VideoFilePeer::TITLE);
			$criteria->addSelectColumn(VideoFilePeer::TRACK);
			$criteria->addSelectColumn(VideoFilePeer::COMMENTS);
			$criteria->addSelectColumn(VideoFilePeer::PATH);
		} else {
	 ...
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 * @return     array (VideoFile object, last column rank)
	 */
	public static function populateObject($row, $startcol = 0)
	{
		$key = VideoFilePeer::getPrimaryKeyHashFromRow($row, $startcol);
		if (null !== ($obj = VideoFilePeer::getInstanceFromPool($key))) {
			// We no longer rehydrate the object, since this can cause data loss.
			// See http://www.propelorm.org/ticket/509
			// $obj->hydrate($row, $startcol, true); // rehydrate
			$col = $startcol + VideoFilePeer::NUM_COLUMNS;
		} else {
			$cls = VideoFilePeer::OM_CLASS;
			$obj = new $cls();
	...
	public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(VideoFilePeer::USER_ID, UserPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of VideoFile objects pre-filled with their User objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of VideoFile objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		VideoFilePeer::addSelectColumns($criteria);
		$startcol = (VideoFilePeer::NUM_COLUMNS - VideoFilePeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key1 = VideoFilePeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj1 = VideoFilePeer::getInstanceFromPool($key1))) {
				// We no longer rehydrate the object, since this can cause data loss.
				// See http://www.propelorm.org/ticket/509
				...
				$obj1 = new $cls();
				$obj1->hydrate($row);
				VideoFilePeer::addInstanceToPool($obj1, $key1);
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (VideoFile) to $obj2 (User)
				$obj2->addVideoFile($obj1);
	...
	/**
	 * Selects a collection of VideoFile objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		VideoFilePeer::addSelectColumns($criteria);
		$startcol2 = (VideoFilePeer::NUM_COLUMNS - VideoFilePeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (VideoFile) to the collection in $obj2 (User)
				$obj2->addVideoFile($obj1);
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$value = $criteria->remove(VideoFilePeer::ID);
			if ($value) {
				$selectCriteria->add(VideoFilePeer::ID, $value, $comparison);
			} else {
				$selectCriteria->setPrimaryTableName(VideoFilePeer::TABLE_NAME);
			}
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += BasePeer::doDeleteAll(VideoFilePeer::TABLE_NAME, $con, VideoFilePeer::DATABASE_NAME);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof VideoFile) { // it's a model object
