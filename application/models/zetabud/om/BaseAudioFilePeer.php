 ...
 */
abstract class BaseAudioFilePeer {
	...
	const OM_CLASS = 'AudioFile';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'zetabud.AudioFile';

	/** the related TableMap class for this table */
	const TM_CLASS = 'AudioFileTableMap';
	...
	const USER_ID = 'audio_file.USER_ID';

	/** the column name for the ARTIST field */
	const ARTIST = 'audio_file.ARTIST';

	/** the column name for the ALBUM field */
	const ALBUM = 'audio_file.ALBUM';

	/** the column name for the TITLE field */
	const TITLE = 'audio_file.TITLE';

	/** the column name for the TRACK field */
	const TRACK = 'audio_file.TRACK';

	/** the column name for the COMMENTS field */
	const COMMENTS = 'audio_file.COMMENTS';

	/** the column name for the PATH field */
	const PATH = 'audio_file.PATH';

	/**
	 * An identiy map to hold any loaded instances of AudioFile objects.
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'Artist', 'Album', 'Title', 'Track', 'Comments', 'Path', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'artist', 'album', 'title', 'track', 'comments', 'path', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USER_ID, self::ARTIST, self::ALBUM, self::TITLE, self::TRACK, self::COMMENTS, self::PATH, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USER_ID', 'ARTIST', 'ALBUM', 'TITLE', 'TRACK', 'COMMENTS', 'PATH', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'artist', 'album', 'title', 'track', 'comments', 'path', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'Artist' => 2, 'Album' => 3, 'Title' => 4, 'Track' => 5, 'Comments' => 6, 'Path' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'artist' => 2, 'album' => 3, 'title' => 4, 'track' => 5, 'comments' => 6, 'path' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_ID => 1, self::ARTIST => 2, self::ALBUM => 3, self::TITLE => 4, self::TRACK => 5, self::COMMENTS => 6, self::PATH => 7, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USER_ID' => 1, 'ARTIST' => 2, 'ALBUM' => 3, 'TITLE' => 4, 'TRACK' => 5, 'COMMENTS' => 6, 'PATH' => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'artist' => 2, 'album' => 3, 'title' => 4, 'track' => 5, 'comments' => 6, 'path' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(AudioFilePeer::USER_ID);
			$criteria->addSelectColumn(AudioFilePeer::ARTIST);
			$criteria->addSelectColumn(AudioFilePeer::ALBUM);
			$criteria->addSelectColumn(AudioFilePeer::TITLE);
			$criteria->addSelectColumn(AudioFilePeer::TRACK);
			$criteria->addSelectColumn(AudioFilePeer::COMMENTS);
			$criteria->addSelectColumn(AudioFilePeer::PATH);
		} else {
	 ...
	 *
	 * @param      AudioFile $value A AudioFile object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(AudioFile $obj, $key = null)
	{
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = AudioFilePeer::getOMClass(false);
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = AudioFilePeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + AudioFilePeer::NUM_COLUMNS;
		} else {
	...
	public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(AudioFilePeer::USER_ID, UserPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of AudioFile objects pre-filled with their User objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		AudioFilePeer::addSelectColumns($criteria);
		$startcol = (AudioFilePeer::NUM_COLUMNS - AudioFilePeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (AudioFile) to $obj2 (User)
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		AudioFilePeer::addSelectColumns($criteria);
		$startcol2 = (AudioFilePeer::NUM_COLUMNS - AudioFilePeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (AudioFile) to the collection in $obj2 (User)
				$obj2->addAudioFile($obj1);
	...
	public static function buildTableMap()
	{
	  ...
	  {
	    $dbMap->addTableObject(new AudioFileTableMap());
	  }
	}
	...
	{
		return $withPrefix ? AudioFilePeer::CLASS_DEFAULT : AudioFilePeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a AudioFile or Criteria object.
	 *
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($criteria->containsKey(AudioFilePeer::ID) && $criteria->keyContainsValue(AudioFilePeer::ID) ) {
	...
	/**
	 * Method perform an UPDATE on the database, given a AudioFile or Criteria object.
	 *
	...
	/**
	 * Method to DELETE all rows from the audio_file table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a AudioFile or Criteria object OR a primary key value.
	 *
	 ...
	 */
	public static function doValidate(AudioFile $obj, $cols = null)
	{
		$columns = array();
