...
abstract class BaseEmailPeer {
	...
	const CLASS_DEFAULT = 'zetabud.Email';
	...
	const USER_FROM_ID = 'email.USER_FROM_ID';

	/** the column name for the USER_TO_ID field */
	const USER_TO_ID = 'email.USER_TO_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserFromId', 'UserToId', 'Subject', 'Text', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userFromId', 'userToId', 'subject', 'text', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USER_FROM_ID, self::USER_TO_ID, self::SUBJECT, self::TEXT, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USER_FROM_ID', 'USER_TO_ID', 'SUBJECT', 'TEXT', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_from_id', 'user_to_id', 'subject', 'text', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserFromId' => 1, 'UserToId' => 2, 'Subject' => 3, 'Text' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userFromId' => 1, 'userToId' => 2, 'subject' => 3, 'text' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_FROM_ID => 1, self::USER_TO_ID => 2, self::SUBJECT => 3, self::TEXT => 4, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USER_FROM_ID' => 1, 'USER_TO_ID' => 2, 'SUBJECT' => 3, 'TEXT' => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_from_id' => 1, 'user_to_id' => 2, 'subject' => 3, 'text' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(EmailPeer::USER_FROM_ID);
			$criteria->addSelectColumn(EmailPeer::USER_TO_ID);
			$criteria->addSelectColumn(EmailPeer::SUBJECT);
			$criteria->addSelectColumn(EmailPeer::TEXT);
		} else {
			$criteria->addSelectColumn($alias . '.ID');
			$criteria->addSelectColumn($alias . '.USER_FROM_ID');
			$criteria->addSelectColumn($alias . '.USER_TO_ID');
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = EmailPeer::getOMClass(false);
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = EmailPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + EmailPeer::NUM_COLUMNS;
		} else {
	...
	public static function doCountJoinUserFrom(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(EmailPeer::USER_FROM_ID, UserPeer::ID, $join_behavior);
	...
	public static function doCountJoinUserTo(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(EmailPeer::USER_TO_ID, UserPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Email objects pre-filled with their User objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinUserFrom(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		EmailPeer::addSelectColumns($criteria);
		$startcol = (EmailPeer::NUM_COLUMNS - EmailPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Email) to $obj2 (User)
				$obj2->addEmailRelatedByUserFromId($obj1);
	...
	public static function doSelectJoinUserTo(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Email) to $obj2 (User)
				$obj2->addEmailRelatedByUserToId($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		EmailPeer::addSelectColumns($criteria);
		$startcol2 = (EmailPeer::NUM_COLUMNS - EmailPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Email) to the collection in $obj2 (User)
				$obj2->addEmailRelatedByUserFromId($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (Email) to the collection in $obj3 (User)
				$obj3->addEmailRelatedByUserToId($obj1);
			} // if joined row not null
	...
	/**
	 * Selects a collection of Email objects pre-filled with all related objects except UserFrom.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	/**
	 * Selects a collection of Email objects pre-filled with all related objects except UserTo.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	{
		return $withPrefix ? EmailPeer::CLASS_DEFAULT : EmailPeer::OM_CLASS;
	}
	...
	/**
	 * Method to DELETE all rows from the email table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
