...
abstract class BaseNote extends BaseObject  implements Persistent
{
	...
	public function setText($v)
	{
		...
		if ($this->text !== $v) {
			$this->text = $v;
			$this->modifiedColumns[] = NotePeer::TEXT;
		}
	...
	public function setCreatedDate($v)
	{
		...
		if ( $this->created_date !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = NotePeer::CREATED_DATE;
			}
	...
	public function setModifiedDate($v)
	{
		...
		if ( $this->modified_date !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = NotePeer::MODIFIED_DATE;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->modified_date = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->resetModified();
			...
			return $startcol + 5; // 5 = NotePeer::NUM_COLUMNS - NotePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NotePeer::TEXT)) $criteria->add(NotePeer::TEXT, $this->text);
		if ($this->isColumnModified(NotePeer::CREATED_DATE)) $criteria->add(NotePeer::CREATED_DATE, $this->created_date);
		if ($this->isColumnModified(NotePeer::MODIFIED_DATE)) $criteria->add(NotePeer::MODIFIED_DATE, $this->modified_date);
