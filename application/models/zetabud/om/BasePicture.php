...
abstract class BasePicture extends BaseObject  implements Persistent
{
	...
	public function setTitle($v)
	{
		...
		if ($this->title !== $v) {
			$this->title = $v;
			$this->modifiedColumns[] = PicturePeer::TITLE;
		}
	...
	public function setCaption($v)
	{
		...
		if ($this->caption !== $v) {
			$this->caption = $v;
			$this->modifiedColumns[] = PicturePeer::CAPTION;
		}
	...
	public function setOrientation($v)
	{
		...
		if ($this->orientation !== $v) {
			$this->orientation = $v;
			$this->modifiedColumns[] = PicturePeer::ORIENTATION;
		}
	...
	public function setRating($v)
	{
		...
		if ($this->rating !== $v) {
			$this->rating = $v;
			$this->modifiedColumns[] = PicturePeer::RATING;
		}
	...
	public function setCreatedDate($v)
	{
		...
		if ( $this->created_date !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = PicturePeer::CREATED_DATE;
			}
	...
	public function setModifiedDate($v)
	{
		...
		if ( $this->modified_date !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = PicturePeer::MODIFIED_DATE;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->orientation = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->rating = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->created_date = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->modified_date = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->resetModified();
			...
			return $startcol + 8; // 8 = PicturePeer::NUM_COLUMNS - PicturePeer::NUM_LAZY_LOAD_COLUMNS).
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(PicturePeer::ID) ) {
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[4], $arr)) $this->setOrientation($arr[$keys[4]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PicturePeer::TITLE)) $criteria->add(PicturePeer::TITLE, $this->title);
		if ($this->isColumnModified(PicturePeer::CAPTION)) $criteria->add(PicturePeer::CAPTION, $this->caption);
		if ($this->isColumnModified(PicturePeer::ORIENTATION)) $criteria->add(PicturePeer::ORIENTATION, $this->orientation);
		if ($this->isColumnModified(PicturePeer::RATING)) $criteria->add(PicturePeer::RATING, $this->rating);
		if ($this->isColumnModified(PicturePeer::CREATED_DATE)) $criteria->add(PicturePeer::CREATED_DATE, $this->created_date);
		if ($this->isColumnModified(PicturePeer::MODIFIED_DATE)) $criteria->add(PicturePeer::MODIFIED_DATE, $this->modified_date);
