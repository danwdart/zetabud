...
/**
 * Base static class for performing query and update operations on the 'note' table.
 *
 * 
 *
...
abstract class BaseNotePeer {
	...
	const CLASS_DEFAULT = 'zetabud.Note';
	...
	const CREATED_DATE = 'note.CREATED_DATE';

	/** the column name for the MODIFIED_DATE field */
	const MODIFIED_DATE = 'note.MODIFIED_DATE';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'Text', 'CreatedDate', 'ModifiedDate', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'text', 'createdDate', 'modifiedDate', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USER_ID, self::TEXT, self::CREATED_DATE, self::MODIFIED_DATE, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USER_ID', 'TEXT', 'CREATED_DATE', 'MODIFIED_DATE', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'text', 'created_date', 'modified_date', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'Text' => 2, 'CreatedDate' => 3, 'ModifiedDate' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'text' => 2, 'createdDate' => 3, 'modifiedDate' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_ID => 1, self::TEXT => 2, self::CREATED_DATE => 3, self::MODIFIED_DATE => 4, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USER_ID' => 1, 'TEXT' => 2, 'CREATED_DATE' => 3, 'MODIFIED_DATE' => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'text' => 2, 'created_date' => 3, 'modified_date' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(NotePeer::TEXT);
			$criteria->addSelectColumn(NotePeer::CREATED_DATE);
			$criteria->addSelectColumn(NotePeer::MODIFIED_DATE);
		} else {
	...
	/**
	 * Method to invalidate the instance pool of all tables related to note
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = NotePeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + NotePeer::NUM_COLUMNS;
		} else {
	...
	public static function doSelectJoinUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		NotePeer::addSelectColumns($criteria);
		$startcol = (NotePeer::NUM_COLUMNS - NotePeer::NUM_LAZY_LOAD_COLUMNS);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		NotePeer::addSelectColumns($criteria);
		$startcol2 = (NotePeer::NUM_COLUMNS - NotePeer::NUM_LAZY_LOAD_COLUMNS);
	...
	/**
	 * Method to DELETE all rows from the note table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
